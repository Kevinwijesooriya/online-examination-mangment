...
public class QuizActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int categoryID = intent.getIntExtra(qMainActivity.EXTRA_CATEGORY_ID, 0);
        String categoryName = intent.getStringExtra(qMainActivity.EXTRA_CATEGORY_NAME);
        String difficulty = intent.getStringExtra(qMainActivity.EXTRA_DIFFICULTY);

        textViewCategory.setText("Category: " + categoryName);
        textViewDifficulty.setText("Difficulty: " + difficulty);

        if (savedInstanceState == null) {
            com.example.exapp.QuizDbHelper dbHelper = com.example.exapp.QuizDbHelper.getInstance(this);
    ...
    public void onBackPressed() {
        if (backPressedTime + 2000 > System.currentTimeMillis()) {
            ...
            Toast.makeText(this, "Press back agin to finish", Toast.LENGTH_SHORT).show();
        }
